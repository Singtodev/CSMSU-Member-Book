            ...
            <div class="navbar_container_middle flex flex-row gap-3 items-center">
                <div class="navbar menu flex items-center p-3 gap-x-6 font-bold">
                            ...
                            <a href="./add.php"><div class="
                                ...
                                hover:bg-white
                                hover:text-black
                                text-white px-5 py-2 rounded-xl"> <i class="fa-solid fa-user-plus hover:text-black"></i> Add Member</div></a>
                            <a href="./search.php"><div class="
                                ...
                                text-white hover:text-black px-5 py-2 rounded-xl"><i class="fa-solid fa-magnifying-glass hover:text-black"></i> Search Member</div></a>
                                ...
                                items-center
                                bg-white
                                text-black hover:text-black px-5 py-2 rounded-xl"><i class="fa-solid fa-id-card-clip hover:text-black"></i>Contacts US</div></a>
