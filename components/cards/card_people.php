...
class CardPeople {
    ...
    public function buildCard() {
        ...
        $html .=    '<div class="flex items-center text-slate-600 tracking-wide lg:text-md whitespace-nowrap">'.($this->gender == 'male' ? '<i class="fa-solid fa-person text-3xl text-cyan-400"></i>' : '<i class="fa-solid fa-person text-3xl text-pink-400"></i>').'</div>';
        $html .= '</div>';
        return $html;
    }
